...
char *COM_GetBaseDir()
{
	...
	if (GetModuleFileNameA((HMODULE)nullptr, basedir, sizeof(basedir)))
	{
...
void COM_DefaultExtension(char *path, char *extension)
{
	...
	Q_strcat(path, extension, strlen);
}
...
char *COM_VarArgs(const char *format, ...)
{
	va_list argptr;
