...
class IEngineWrapper: public ISystemModule {
public:
	...
	virtual char *GetCvarString(const char *szName) = 0;
	...
	virtual void CL_DemoPlaySound(int channel, const char *sample, float attenuation, float volume, int flags, int pitch) = 0;
