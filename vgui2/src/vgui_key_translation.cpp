...
static int s_pKeyCodeToVirtual[vgui2::KEY_CODE_COUNT];
...
void KeyCode_InitKeyTranslationTable()
{
    ...
    s_pVirtualKeyToKeyCode[VK_RETURN] = vgui2::KEY_PAD_ENTER;
    ...
    s_pVirtualKeyToKeyCode[VK_CAPITAL] = vgui2::KEY_CAPSLOCK;
    s_pVirtualKeyToKeyCode[VK_NUMLOCK] = vgui2::KEY_NUMLOCK;
    ...
    s_pVirtualKeyToKeyCode[VK_PAUSE] = vgui2::KEY_BREAK;
    s_pVirtualKeyToKeyCode[VK_SHIFT] = vgui2::KEY_RSHIFT;
    s_pVirtualKeyToKeyCode[VK_SHIFT] = vgui2::KEY_LSHIFT; // SHIFT -> left SHIFT
    s_pVirtualKeyToKeyCode[VK_MENU] = vgui2::KEY_RALT;
    s_pVirtualKeyToKeyCode[VK_MENU] = vgui2::KEY_LALT; // ALT -> left ALT
    s_pVirtualKeyToKeyCode[VK_CONTROL] = vgui2::KEY_RCONTROL;
    s_pVirtualKeyToKeyCode[VK_CONTROL] = vgui2::KEY_LCONTROL; // CTRL -> left CTRL
